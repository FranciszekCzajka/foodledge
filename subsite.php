    ...
    <body>
        <nav class="navbar">
            ...
            <div class="search-engine-v2">
                <input type="text" class="search-query query-2" name="text-query" placeholder="Wpisz wyszukiwany obiekt" />
        ...
        <nav class="sidebar">
            ...
            <div class="back-to-main">
                <a class="main-site" href="index.php">Powrót do strony głownej</a>
            </div>
        ...
        <script type="text/javascript">
            ...
            if (Cookies.get("lang") == 1) {
                ...
                $(".main-site").html("Go back to main site");
        ...
        <script>
            $(document).ready(function () {
                $("#poland").click(function () {
                    ...
                    $(".main-site").html("Powrót do strony głownej");
